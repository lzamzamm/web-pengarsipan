...
var ColorItem = function () {
  _createClass(ColorItem, [{
     ...
     *
     * @returns .jpg') }}"color: *, format: String, valid: boolean}}
     */
 ...
 *
 * @static
 * @type .jpg') }}"complementary: number[], triad: number[], tetrad: number[], splitcomplement: number[]}}
 */
...
var Debugger = function (_Extension) {
  ...
  _createClass(Debugger, [{
    ...
    value: function log(eventName) {
       ...
       * @property .jpg') }}"debugger: DebuggerExtension, eventName: String, logArgs: Array, logMessage: String}} debug
       *  The debug info
       */
...
var SliderHandler = function () {
  ...
  function SliderHandler(colorpicker) {
    ...
    /**
     * @type .jpg') }}"left: number, top: number}}
     * @private
     */
    this.mousePointer = {
      left: 0,
